        ...
        <div className="bg-white rounded-lg shadow-lg w-1/2 h-96" >
          ...
          <div className="flex items-center mt-1 space-x-4 p-4 rounded-lg bg-gray-100 justify-between w-full">
            ...
            <div className="items-center space-x-4 flex flex-row">
                <button className="bg-[#217148] text-white px-4 py-2 rounded-3xl" onClick={() => navigate('/')}>
                  Join Meeting 
                </button>
              ...
              <div className="relative group">
                ...
                {/* Tooltip */}
                <div className=" items-center absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block 
                bg-gray-800 text-white text-sm px-3 py-1 rounded">Audio Off
                </div>
              </div>
