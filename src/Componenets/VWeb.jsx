...
const VWeb = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      userData.sessionToken = sessionToken; // Store session token
      setUser(userData);
  ...
  useEffect(() => {
    if (!user || !user.meetingID || !user.sessionToken) return;
    ws = new WebSocket(
    ...
    ws.onopen = () => {
      ...
      // Basic WebRTC signaling initiation (to be expanded)
    //   const subMsg = {
    //     msg: "method",
    //     method: "join",
    //     params: [user.meetingID, user.internalUserID, user.sessionToken],
    //   };
    //   sendWSMessage(subMsg);
    // };

    ws.onmessage = (event) => {
      console.log("Raw WebSocket message from SFU:", event.data);
      let data = event.data;
...
// import Gridone from "../Images/Frame 1707480527.png";
// import Gridtwo from "../Images/Icons 3.png";
// import Muted from "../Images/Icon/microphone-slash.png";
// import Unmute from "../Images/Icon/Mic.png";
// import hand from "../Images/Icon/hand.png";
// import recordIcon from "../Images/Icon/recordIcon.png";
// import axios from "axios";
...
//       console.log("Audio avaialable:", stream);
//       setLocalStream(stream);
//       setHostAudio(true);
//     //   participants.forEach((p) => {
//     //     if (p.peerConnection) {
...
//                 >
//                   <img
//                     src={participant.hasAudio ? Unmute : Muted}
//                     alt={participant.hasAudio ? "mic on" : "mic off"}
//                     className="w-4 h-4"
//                   />
//                 </button>
